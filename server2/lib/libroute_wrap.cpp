...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__libroute

#else
#  define SWIG_init    init_libroute

#endif
#define SWIG_name    "_libroute"
...
SWIGINTERN int Swig_var_path_size_set(PyObject *_val) {
  {
    int val;
    int res = SWIG_AsVal_int(_val, &val);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""path_size""' of type '""int""'");
    }
    path_size = static_cast< int >(val);
  }
  return 0;
fail:
  return 1;
...
SWIGINTERN PyObject *Swig_var_path_size_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_int(static_cast< int >(path_size));
  return pyobj;
}


SWIGINTERN PyObject *_wrap_get_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)":get_size")) SWIG_fail;
  result = (int)get_size();
...
SWIGINTERN PyObject *_wrap_get_path(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:get_path",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_double, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "get_path" "', argument " "1"" of type '" "double *""'"); 
  }
  arg1 = reinterpret_cast< double * >(argp1);
  get_path(arg1);
  resultobj = SWIG_Py_Void();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"get_size", _wrap_get_size, METH_VARARGS, NULL},
...
SWIG_init(void) {
  ...
  SWIG_addvarlink(SWIG_globals(),(char*)"path_size",Swig_var_path_size_get, Swig_var_path_size_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
